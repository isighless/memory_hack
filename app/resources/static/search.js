(function( search, $, undefined ) {
    ...
    var li_template = (['<ons-list-item class="result-row">',
          '<ons-row class="result-header">',
            '<ons-col align="center" class="col ons-col-inner address" width="70%">##address##</ons-col>',
            '<ons-col align="center" class="col ons-col-inner address-controls" width="30%">',
              '<label class="checkbox checkbox--material">',
                '<input tabIndex="-1" id="search_freeze_##index##" type="checkbox" class="checkbox__input checkbox--material__input freeze" data-address="##address##" onchange="search.result_freeze(this, ##index##)">',
                '<div class="checkbox__checkmark checkbox--material__checkmark"></div>',
              '</label>',
              '<ons-button modifier="quiet" name="add_button" data-address="##address##" onclick="search.copy_result(##index##, this)"><ons-icon icon="md-copy"/></ons-button>',
            '</ons-col>',
          '</ons-row>',
          '<ons-row class="result-value-row">',
            '<ons-col width="100%" align="center" class="col ons-col-inner">',
              '<input tabIndex="-1" type="text" id="result_value_##index##" data-address="##address##" name="search_value" class="text-input text-input--material r-value" value="##value##" onkeydown="search.result_change(this)" onblur="search.result_change(this)" autocomplete="chrome-off">',
            '</ons-col>',
          '</ons-row>',
      '</ons-list-item>',
    ]).join("\n");
